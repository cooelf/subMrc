...
def create_parser():
    ...
    parser.add_argument(
        '--input', '-i', type=argparse.FileType('r'), default="output/bpe_corpus.txt",
        metavar='PATH',
        help="Input text (default: standard input).")

    parser.add_argument(
        '--output', '-o', type=argparse.FileType('w'), default="output/codes_bpe_1k.txt",
        metavar='PATH',
        help="Output file for BPE codes (default: standard output)")
    parser.add_argument(
        '--symbols', '-s', type=int, default=1000,
