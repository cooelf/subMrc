...
def create_parser():
    ...
    parser.add_argument(
        '--input', '-i', type=argparse.FileType('r'), default="sample/vocab.txt",
        metavar='PATH',
        help="Input file (default: standard input).")
    parser.add_argument(
        '--codes', '-c', type=argparse.FileType('r'), default="output/codes_bpe_1k.txt",
        metavar='PATH',
    ...
    parser.add_argument(
        '--output', '-o', type=argparse.FileType('w'), default="output/vocab_bpe_1k_raw.txt",
        metavar='PATH',
